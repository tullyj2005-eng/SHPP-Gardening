                ...
                return ListView(
                  ...
                  children: [
                    ...
                    _buildResponsiveGrid(constraints.maxWidth, [
                      ...
                      chocolateMintPlant(context, () => widget.onTrack('Chocolate Mint')),
                      spearmintPlant(context, () => widget.onTrack('Spearmint')),
                      pennyRoyalPlant(context, () => widget.onTrack('Pennyroyal')),
                    ]),
                  ],
                );
              },
